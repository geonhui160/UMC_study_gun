...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -60048188L;
    ...
    public final umc.spring_week5.domain.QMember member;

    public final umc.spring_week5.domain.QMission mission;

    public final EnumPath<umc.spring_week5.domain.enums.MissionStatus> status = createEnum("status", umc.spring_week5.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.spring_week5.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.spring_week5.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
